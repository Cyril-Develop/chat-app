...
const Hero = () => {
  return (
    <main className="flex flex-col-reverse xl:flex-row justify-center items-center xl:items-center space-x-0 xl:space-x-6 py-8 px-4 md:px-10 h-[calc(100vh-96px)] w-full max-w-[1600px] mx-auto">
