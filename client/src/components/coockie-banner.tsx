...
const CookieBanner = () => {
  ...
  return (
    <div className="fixed bottom-0 md:bottom-10 left-0 md:left-10 rounded-md w-full max-w-[600px] bg-background dark:bg-background p-4 shadow-md border-t border-border flex flex-col space-y-3 z-50 ">
      <h3 className="leading-none">Nous respectons ta vie privée 🔒</h3>
